          ...
          >
            ...
            >
              <img
                :src="
                  state.thumbnailFile
                    ? createObjectUrl(state.thumbnailFile)
                    : defaultThumbnail
                "
                class="size-full"
              />
              <div
                class="absolute size-full flex flex-col items-center justify-center gap-3 bg-black/50 opacity-0 hover:opacity-100 transition"
              >
