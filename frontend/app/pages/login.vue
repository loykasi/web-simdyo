...
const redirectRoute = computed(() => decodeURIComponent(route.query.redirect as string || ""));
    ...
    <div class="w-full">
      <UForm ref="form" :schema="schema" :state="state" class="space-y-4" @submit="onSubmit">
        <UFormField label="Email" name="email">
          <UInput v-model="state.email" placeholder="Your email address" class="w-full mt-1" />
        </UFormField>
        ...
        <UButton type="submit" class="flex w-full py-2 justify-center" :loading="loading">
          Login
        </UButton>
      </UForm>
    </div>
